# [create website, CMS, or... with nodejs reactjs express mongodb | Nodeeweb](https://idehweb.com/product/creare-website-or-application-with-nodeeweb/)
...
== 1. Create index.mjs file and put:
